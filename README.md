...
![Docker Automated build](https://img.shields.io/docker/automated/coderpatros/sftp.svg) ![Docker Build Status](https://img.shields.io/docker/build/coderpatros/sftp.svg) ![Docker Stars](https://img.shields.io/docker/stars/coderpatros/sftp.svg) ![Docker Pulls](https://img.shields.io/docker/pulls/coderpatros/sftp.svg)

![OpenSSH logo](https://raw.githubusercontent.com/coderpatros/docker-sftp/master/openssh.png "Powered by OpenSSH")

# Supported tags and respective `Dockerfile` links

- [`alpine` (*Dockerfile*)](https://github.com/coderpatros/docker-sftp/blob/alpine/Dockerfile) [![](https://images.microbadger.com/badges/image/coderpatros/sftp:alpine.svg)](http://microbadger.com/images/coderpatros/sftp:alpine "Get your own image badge on microbadger.com")
...
```
docker run -p 22:22 -d coderpatros/sftp foo:pass:::upload
```
